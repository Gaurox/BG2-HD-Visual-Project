...
liés dans `pipeline/tests`. Les chemins locaux passent par `config://`. Ne jamais réécrire un run
historique : produire une nouvelle version lorsque son remplacement est nécessaire.
