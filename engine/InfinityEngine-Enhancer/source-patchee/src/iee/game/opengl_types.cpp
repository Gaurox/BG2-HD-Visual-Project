...
bool OpenGLFunctions::initialize() noexcept {
  ...
  glGetTexLevelParameteriv = reinterpret_cast<PFN_glGetTexLevelParameteriv>(
      get_gl1_proc_address(opengl32, "glGetTexLevelParameteriv"));
  glGetTexImage =
      reinterpret_cast<PFN_glGetTexImage>(get_gl1_proc_address(opengl32, "glGetTexImage"));
  ...
  glTexSubImage2D = reinterpret_cast<PFN_glTexSubImage2D>(
      get_gl1_proc_address(opengl32, "glTexSubImage2D"));
  glDeleteTextures =
  ...
  glCopyTexSubImage2D = reinterpret_cast<PFN_glCopyTexSubImage2D>(
      get_gl1_proc_address(opengl32, "glCopyTexSubImage2D"));
  ...
  glBlendFunc =
      reinterpret_cast<PFN_glBlendFunc>(get_gl1_proc_address(opengl32, "glBlendFunc"));
  glViewport = reinterpret_cast<PFN_glViewport>(get_gl1_proc_address(opengl32, "glViewport"));
  glScissor = reinterpret_cast<PFN_glScissor>(get_gl1_proc_address(opengl32, "glScissor"));
  ...
  glDrawArrays =
      reinterpret_cast<PFN_glDrawArrays>(get_ext_proc_address(opengl32, "glDrawArrays"));
  ...
  if (valid) {
    ...
    LOG_DEBUG(
        ...
        "glGetIntegerv={}, glGetTexParameteriv={}, glGetTexLevelParameteriv={}, "
        "glGetTexImage={}, glGetError={}, glGenTextures={}, glBindTexture={}, "
        "glTexImage2D={}, glTexSubImage2D={}, glDeleteTextures={}, glPixelStorei={}, "
        ...
        glGetTexLevelParameteriv != nullptr, glGetTexImage != nullptr, glGetError != nullptr,
        glGenTextures != nullptr, glBindTexture != nullptr, glTexImage2D != nullptr,
        glTexSubImage2D != nullptr, glDeleteTextures != nullptr, glPixelStorei != nullptr,
        glCompressedTexImage2D != nullptr, glGenerateMipmap != nullptr);
  } else {
