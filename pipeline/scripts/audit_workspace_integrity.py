...
SOURCE_TABLES: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "path_field": "extracted_path",
        "hash_field": "source_sha256",
        "root": "icons/ressources",
        "exclude_runs": True,
        "canonical_path": "icons/index/resources.csv",
    },
    {
        "name": "icon-pvrz-dependencies",
        "domain": "icons",
        "csv": "icons/index/dependencies.csv",
        "manifest": "icons/index/manifest.json",
        "manifest_count_field": "dependency_count",
        "path_field": "extracted_path",
        "hash_field": "source_sha256",
        "availability_field": "present",
        "available_values": ("yes",),
        "root": "icons/dependencies/pvrz",
        "canonical_path": None,
    },
    {
        "name": "cursors",
