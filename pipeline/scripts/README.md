...
| Eau et overlays | `orchestrate_water_batch.py` (plan-only), `build_water_route1_batch.py`, `repair_water_secondary_alpha_seams.py`, `assemble_water_qa_batches.py`, `audit_water_area.py`, `build_spline_map_alpha.py`, `render_liquid_overlay_mask.py`, `build_water_contour_feather.py` |
