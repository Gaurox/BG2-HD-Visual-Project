...
// fpTone.glsl — generated by tools/build_water_tone_shader.py
...
// Keep the native fpTone sampler for both the fallback and atlas phases.
...
void main()
{
    // Route2-only adapter: no legacy cell-wide replacement on weather draws.
