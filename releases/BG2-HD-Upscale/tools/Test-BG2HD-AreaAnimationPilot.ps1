...
Require ($rendererCandidate.bundle_id -eq 'iee-0.1.0-alpha.6' -and $rendererCandidate.status -eq 'frozen-awaiting-clean-game-validation') 'Etat du renderer candidat animation inattendu.'
