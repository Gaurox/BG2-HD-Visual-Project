...
- Étape suivante : jeu + InfinityLoader fermés, installer cette génération dérivée, puis QA ingame de plusieurs armures/casques/boucliers/armes. Annoncer tout GPU futur ; aucun GPU requis pour l'installation.
