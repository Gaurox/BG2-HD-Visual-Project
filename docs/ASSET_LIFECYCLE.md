...
| Sprite | source : `sprite/ressources/<RESREF>/sources/<sha>/`; jobs/runs : `sprite/families/<macro>/.../<famille>/` | génération courante ; décisions QA ; reçu d'installation ; candidats release |
