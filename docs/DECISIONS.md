...
| Rayon du fondu interne d'une petite flamme `Blended` (ReboutCX + premultiply) | balayage sur la sortie ReboutCX réelle, plus grand rayon gardant le cœur p95 ≥ -5 % (`FLAME2L` : 12 = +0,4 %, 16 = -2,6 %, 20 = -9,7 % avec frange verdâtre) ; la proportion 0,83 × rayon inscrit x4 des frères donnait 20, trop dur | nouvelle flamme : la proportion ne suffit pas, balayer |
