...
```text
sprite/families/playable-characters/6102-dwarf-male-fighter/cdmb1/variants/xbr2x-aa/jobs/dwarf-male-fighter-cdmb1-aa-xbr2x.json
```
...
```text
sprite/families/playable-characters/6102-dwarf-male-fighter/cdmb1/variants/xbr2x-aa/runs/xbr2x-aa-x2/build/build-manifest.json
```
...
```text
sprite/families/playable-characters/6102-dwarf-male-fighter/cdmb1/variants/xbr2x-aa/runs/xbr2x-aa-x2/ingame-test/active-test.json
```
