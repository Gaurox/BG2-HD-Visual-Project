...
|---|---|---|
| x2 NEAREST sans AA | [`jobs/dwarf-male-fighter-complete-xn-xbr2x.json`](jobs/dwarf-male-fighter-complete-xn-xbr2x.json) | `sprite/dwarf_male_fighter_complete_xn_xbr2x/runs/xbr2x-x2-xn` |
| x2 LINEAR sans AA | même pack x2 | `sprite/dwarf_male_fighter_complete_xn_xbr2x/runs/xbr2x-x2-xn/ingame-test/linear-filter-test-20260825-2358/test-manifest.json` |
| x2 NEAREST AA | [`jobs/dwarf-male-fighter-cdmb1-aa-xbr2x.json`](jobs/dwarf-male-fighter-cdmb1-aa-xbr2x.json) | `sprite/dwarf-male-fighter-cdmb1-aa/runs/xbr2x-aa-x2` |
| x4 NEAREST sans AA | [`jobs/dwarf-male-fighter-cdmb1-xbr4x.json`](jobs/dwarf-male-fighter-cdmb1-xbr4x.json) | `sprite/dwarf-male-fighter-cdmb1-x4/runs/xbr4x-x4` |
...
```powershell
$jobX4 = 'sprite/jobs/dwarf-male-fighter-cdmb1-xbr4x.json'
...
```powershell
$jobAA = 'sprite/jobs/dwarf-male-fighter-cdmb1-aa-xbr2x.json'
