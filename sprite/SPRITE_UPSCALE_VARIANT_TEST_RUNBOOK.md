...
contrat x2 historique   sprite/SPRITE_UPSCALE_PIPELINE.md
contrat xN/x4 V3        sprite/SPRITE_UPSCALE_XN_FOUNDATION.md
contrat xBR             sprite/UPSCALE_XBR2X.md
...
Résoudre l'animation, la famille et les ressources selon [`README.md`](README.md). Exiger :
...
```text
sprite/jobs/<sprite>-<variant>.json
sprite/<sprite>-<variant>/source/
sprite/<sprite>-<variant>/runs/<variant>/
engine/InfinityEngine-Enhancer/source-patchee/cmake-build-<sprite>-<variant>/
sprite/<sprite>-<variant>/runs/<variant>/ingame-test/
```
...
```powershell
$job = 'sprite/jobs/<sprite>-xbr2x.json' # ou <sprite>-xbr4x.json
$template = 'sprite/jobs/<job-xn-v3-verifie>.json'
