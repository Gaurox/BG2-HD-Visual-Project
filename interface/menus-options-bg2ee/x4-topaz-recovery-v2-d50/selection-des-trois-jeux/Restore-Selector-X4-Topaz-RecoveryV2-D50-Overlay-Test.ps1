...
if (Get-Process -Name Baldur, InfinityLoader -ErrorAction SilentlyContinue) {
    throw 'Quittez BG2EE et InfinityLoader avant la restauration.'
}
...
$assets = @('MAINMENU-MOS0181-x4.dxt5', 'SELECTOR-MOS0182-x4.dxt5', 'SELECTOR-MOS0183-x4.dxt5', 'SELECTOR-MOS0184-x4.dxt5', 'SELECTOR-MOS0185-x4.dxt5', 'MAINMENU-MOS0258-x4.dxt5', 'SELECTOR-MOS0259-x4.dxt5')
...
Write-Host "Overlay sélecteur restauré depuis : $backup"
