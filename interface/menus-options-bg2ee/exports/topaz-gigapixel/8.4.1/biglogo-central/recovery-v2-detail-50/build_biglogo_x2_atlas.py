...
def main() -> None:
    ...
    topaz = Image.open(ROOT / "x2" / "BIGLOGO-options-frame-0-original-topaz-recovery-v2-detail-50-x2.png").convert("RGBA")
    ...
    preview = output / "BIGLOGO-MOS0017-x2-topaz-recovery-v2-detail-50-preview.png"
    atlas.save(preview)
    buffer = io.BytesIO()
    ...
    asset = output / "BIGLOGO-MOS0017-x2-topaz-recovery-v2-detail-50.dxt5"
